window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function injectCss() {
      ...
      tag.setAttribute("data-tavily-search-css", "4");
      tag.textContent = [
                ...
                children: [
                  ...
                  react_jsx_runtime.jsxs("label", {
                    ...
                    children: [
                      ...
                      state.enabled
                        ? (t ? t("enabledHint") : "当前 web_search 将请求 Tavily。无 Key 则走 keyless。")
    ...
    function apply(ctx) {
      ...
      const en = {
        ...
        enabledHint: "web_search will call Tavily. No key uses keyless mode.",
      ...
      const zh = {
        ...
        enabledHint: "当前 web_search 将请求 Tavily。无 Key 则走 keyless。",
