window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function injectCss() {
      ...
      tag.setAttribute("data-tavily-search-css", "3");
      tag.textContent = [
        ...
        ".tvly_switch{display:flex;align-items:center;gap:8px;font:inherit;font-size:13px;line-height:1.5;color:var(--dsw-alias-label-primary);cursor:pointer}",
    ...
    function TavilyCard(props) {
      ...
      const description = t ? t("description") : "打开后 web_search 走 Tavily；关闭后仍用官方 DeepSeek 搜索";
              ...
              react_jsx_runtime.jsxs("div", {
                ...
                children: [
                  react_jsx_runtime.jsx("div", {
                    ...
                    children: react_jsx_runtime.jsx("span", { className: "tvly_label", children: t ? t("enable") : "使用 Tavily（关闭则走官方 DeepSeek）" }),
                  }),
                  react_jsx_runtime.jsxs("label", {
                    ...
                    children: [
                      ...
                      state.enabled
                        ? (t ? t("enabledHint") : "当前 web_search 将请求 Tavily。")
                        : (t ? t("disabledHint") : "当前 web_search 仍走官方 DeepSeek 搜索。"),
                    ],
                  }),
                ],
              }),
              react_jsx_runtime.jsxs("div", {
                ...
                children: [
                  ...
                  react_jsx_runtime.jsx("input", {
                    ...
                    type: "password",
                    placeholder: t ? t("keyPlaceholder") : "留空表示保持当前密钥。",
                  ...
                  react_jsx_runtime.jsx("p", {
                    className: "tvly_hint",
                    children: t ? t("keyHint") : "不写入设置文件。留空表示保持当前密钥。",
                  }),
                ],
              }),
              react_jsx_runtime.jsxs("div", {
    ...
    function apply(ctx) {
      ...
      const en = {
        ...
        description: "On: web_search uses Tavily. Off: official DeepSeek search.",
        enable: "Use Tavily (off = official DeepSeek)",
        enabledHint: "web_search will call Tavily.",
        disabledHint: "web_search still uses official DeepSeek search.",
        unsaved: "Unsaved",
        keyOk: "Key configured.",
        keyMissing: "No key configured.",
        keyPlaceholder: "Leave blank to keep the current key.",
        keyHint: "Not written to the settings file. Leave blank to keep the current key.",
      ...
      const zh = {
        title: "Tavily 网页搜索",
        description: "打开后 web_search 走 Tavily；关闭后仍用官方 DeepSeek 搜索",
        enable: "使用 Tavily（关闭则走官方 DeepSeek）",
        enabledHint: "当前 web_search 将请求 Tavily。",
        disabledHint: "当前 web_search 仍走官方 DeepSeek 搜索。",
        unsaved: "未保存",
        keyOk: "已配置密钥。",
        keyMissing: "未配置密钥。",
        keyPlaceholder: "留空表示保持当前密钥。",
