window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function probeFailText(t, fail) {
      const prefix = t ? t("probeFail") : "失败：";
      const code = fail && fail.code;
      if (code === "timeout") return prefix + (t ? t("probeTimeout") : "超时");
      if (code === "invalid_key") return prefix + (t ? t("probeInvalidKey") : "密钥无效");
      if (code === "network") return prefix + (t ? t("probeNetwork") : "网络错误");
      if (code === "unavailable") return prefix + (t ? t("probeUnavailable") : "测试入口不可用");
      if (code === "http") return prefix + "HTTP " + (fail.status || "");
      const extra = fail && fail.error ? fail.error : "";
      return prefix + (extra || (t ? t("probeUnknown") : "未知错误"));
    }
                ...
                children: [
                  ...
                  react_jsx_runtime.jsx("input", {
                    ...
                    placeholder: state.clearKey
                      ? (t ? t("keyPlaceholderClear") : "保存后将清除当前密钥。")
                      : state.keyConfigured
                  ...
                  react_jsx_runtime.jsx("p", {
                    className: "tvly_hint",
                    children: state.clearKey
                      ? (t ? t("keyHintClear") : "保存后密钥会被删除，之后走无 Key。")
                      : state.keyConfigured
                  ...
                  react_jsx_runtime.jsxs("div", {
                    ...
                    children: [
                      react_jsx_runtime.jsx("button", {
                        ...
                        title: t ? t("probeHint") : "会向 Tavily 发一次真实搜索。已配置 Key 时消耗 1 积分。",
                        onClick: props.probe,
                        children: state.probing
                          ? (t ? t("probeTesting") : "测试中…")
                          : (t ? t("probe") : "连通测试"),
                      }),
                      state.probeStatus === "ok"
                        ? react_jsx_runtime.jsx("p", { className: "tvly_probeStatus", children: t ? t("probeOk") : "连通正常" })
    ...
    function apply(ctx) {
      ...
      const zh = {
        ...
        probeUnknown: "未知错误",
        probeHint: "会向 Tavily 发一次真实搜索。已配置 Key 时消耗 1 积分。",
      };
